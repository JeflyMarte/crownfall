...
**Status:** **1.0.8 再提出準備**（2026-09-17 — 導入入場クラッシュ＋旧端末予防を追加。表示バージョンは 1.0.8 のまま build を上げる）  
...
**1.0.8:** 降臨／長いタイトル DG 入場の Stack overflow 修正＋特典 `SORRY-DESCENT`。**追加（再提出）:** 導入0-0／続きから即終了対策、font-fit 再入ガード横展開、旧端末向け入場・発熱予防
