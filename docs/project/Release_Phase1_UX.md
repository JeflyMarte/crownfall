...
**Status:** **1.0.9 提出準備**（2026-09-25 — 極限任務＋王痕育成）  
...
**1.0.8:** 降臨／長いタイトル DG 入場の Stack overflow 修正＋特典 `SORRY-DESCENT`。導入0-0／font-fit 再入／旧端末予防  
**1.0.9:** 極限任務 EX-01〜10（常設・専用タブ）＋王痕育成 I〜V（方針分岐）＋初回片のニーナ手引き。キャラ名2段／所持切替軽量化。1.0.8 の入場安定化は据置
...
`main` 開発・第2弾検証中は征討・発掘・機巧士ガチャは **ON**（現行デフォルト）。
