...
> 世界観は **戦後生態系（Postwar Ecology）** に刷新（2026-06-26）。世界観 SSOT は **`docs/specs/world/`**（12 文書）に再構成（2026-06-27 cutover）。旧 Bible（`game/16`〜`25` / `29`〜`37`）は削除し `world/` へ統合。
...
| 生態 | `world/03_Ecology.md` | 戦後生態系 総論・デザインルール |
| 分類 | `world/04_Classification.md` | モンスター分類体系（Class I〜VII） |
| Biome | `world/05_Biomes.md` | バイオーム（生態系単位） |
| 命名 | `world/06_MonsterNaming.md` | モンスター命名ガイド |
| 地理 | `world/07_Geography.md` | エルド大陸地理 |
| 組織 | `world/08_SeekersGuild.md` | 探索者ギルド（調査管理機構） |
...
6. 戦闘・敵の文脈: `26_CombatVision.md` + `12_モンスター.md`
