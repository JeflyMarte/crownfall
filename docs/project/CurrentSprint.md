...
| UI chrome | ボタン画像化フェーズ2〜4（DG入場/結果/隊長台帳） | ↩ 撤回（テキスト戻し） |
...
| **次** | **P3-UI-BTN-005** 装備・編成ボタン画像化 | STOP（002〜004撤回後も保留） |
...
| 順 | ID | 内容 | 状態 |
|---|---|---|---|
| 0 | 実機確認 | 必殺 resolve 演出・VFX透過 | **オーナー** |
| 1 | P3-UI-BTN-005 | ボタン画像化フェーズ5（装備・編成） | **STOP**（002〜004撤回後も保留） |
