...
| **P3-DG-APEX-REDEFINE-001** | 征討再定義 — イベント常設・20F・降臨N・エンシェント・⑤クリア後一括。パイロット＝**アルバーク／`north_reach`**。次＝二つ名・セット装備→Impl | アップデート枠 |
...
| （メール要望）発熱・バッテリー | 軽量モード強化（30fps・静止天候・idle停止）実装済。要 iOS 実機確認 |
