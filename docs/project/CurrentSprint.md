...
| 3b | **P3-BUG-EVENT-RETRY-001** | 曜日イベント：結果「再挑戦」が日次回数を消費しない（選択入場のみ消費）。降臨は仕様どおり無制限 | 調査済・Fix GO待ち |
...
| **P3-DG-ABYSS-001** | Biome深層×5。**A/B Impl**／Cレジェンド／D磨きは後続。**天候オフ**（P3-D101-7・11F防止） | アップデート枠 |
...
| **P3-UX-CRYSTAL-EXCAVATE-001** | 魔晶石発掘（案A）— Decision **GO済**。日次1・上限300・日課隣・必殺なし。次＝Impl GO | アップデート枠 |
