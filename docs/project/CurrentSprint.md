...
- 将来システム登録（残）: 助っ人(P3-D036 詳細確定 — a/b 分割。**a=戦闘「編成3+助っ人固定枠1」+イベント助っ人 ✅完了/smoke PASS**, b=ガチャ/ロスター) / ジョブ進化(P3-D037)
  - 助っ人 Known Issue: 助っ人ソードマンがヘイト優先で狙われる（全滅対象外＝実質無敵タンク化）。後続で targeting から助っ人除外
