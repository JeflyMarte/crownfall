...
| **P3-JOB-ENGINEER-001** | 第6職 **機巧士** — 助っ人3＋パッシブ＋必殺＋**L Phase A** 接続済。残＝専用 CHR／立ち絵／L Phase B（ICO・灰冠）。β即投入なし | アップデート枠 |
...
| **P3-DG-ROGUE-001** | **遺跡遠征** — 単騎Lv1・50Fランダム・10Fピック・30F中ボス・50F限定装備・キャラ別ビンゴ。Decision **草案**（`137`）。**GO 待ち**→Impl A→E | アップデート枠 |
| **P3-UX-CRYSTAL-EXCAVATE-001** | 魔晶石発掘（案A）— 日次1・上限300・日課隣・必殺なし | ✅ Impl（要実機）
| （メール要望）エンドコンテンツ | 転生／永続強化／レア周回 — 既存＝深層・降臨・許可点＋征討（128）＋**遺跡遠征**。転生は未Decision |
| （メール要望）発熱・バッテリー | 軽量30fps＋通常45fps・天候ループ抑止 実装済。要 iOS 実機確認 |
