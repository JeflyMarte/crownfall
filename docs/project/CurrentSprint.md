...
| **P3-JOB-ENGINEER-001** | 第6職 **機巧士** — 戦闘核・頭上マーク・**戦鎚種**接続済。キャラ／パッシブ／必殺 GO済。次＝助っ人3＋Passive＋Ult Impl。β即投入なし | アップデート枠 |
| **P3-EQ-WARHAMMER-001** | **戦鎚**（`hammer`）— Decision GO済・COMMON＋職制限接続。ドロップ拡充・専用L・専用ICOは後続 | アップデート枠 |
