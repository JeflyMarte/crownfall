...
| **P3-DG-APEX-REDEFINE-001** | 征討再定義 — 天望＋**星炉火口（`134`）**。Boss 戦力＝アルバーク／フォージ降臨帯（`132`／`135`）。セットは名拒みのみ | アップデート枠 |
| **P3-DG-APEX-SET-001** | 征討エンシェント **名拒みの冠** — GO＋接続済（武5＋防＋飾／付与・敵バフ短縮） | アップデート枠 |
