...
| **1** | **P3-BETA-002** | ③ミストフェン一式（敵6+装備20・P3-D154 の型で反復） | HQ+Impl | **次** |
| 2 | P3-BETA-003/004 | ④沈没航路ブラックショア・⑤最果て氷裂フロストリッジ 一式 | HQ+Impl | Beta |
| — | P3-GACHA-006 | ★3/★4 職固有パッシブ（P3-D155-3） | Impl | ✅ **Closeout** |
| 3 | P3-BAL-007 | ① 装備数量補充（防具+3/装飾+2 で各難易度クォータ充足） | Impl | 未着手 |
| 4 | P3-D155 候補 | ダンジョン解放条件（①クリア→②解放 等） | HQ+オーナー | Decision 待ち |
| 5 | P3-D156 候補 | ダメージ±乱数（ブレークポイント緩和・P3-D153-4） | HQ+オーナー | Decision 待ち |
...
| 決定論戦闘のブレークポイント | 乱数がクリティカルのみのため、ステ1〜2点差でクリア率が数十%跳ぶ（P3-D153-4）。ダメージ±乱数導入は別 Decision で将来検討 |
