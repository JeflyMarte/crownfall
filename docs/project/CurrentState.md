...
2026-08-31（**機巧士スキル専用ICO**: キット7＋必殺3＋職フォールバック。128px接続。`126`）2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）
2026-08-31（**機巧士やや強化 GO＋接続**: スパイク作動×0.65／甲砕中罠×1.15。`126`／BAL-001）
2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）2026-08-31（**フォージ戦闘ICO**: ターン＋スラグ吐息／炉床震動。エルディオン流用解除。`135`）
2026-08-31（**発熱対策パッケージA**: モバイルループ追加抑止・正規化キャッシュ・ダメ数字プール／上限。iOS確認リスト追加）
2026-08-31（**エンシェント案D**: 地力引き上げ＋単品パッシブ12種。3部位加護据置。`137`）2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）
2026-08-31（**フォージ戦闘ICO**: ターン＋スラグ吐息／炉床震動。エルディオン流用解除。`135`）2026-08-31（**星炉火口 専用DG ICO／BAN**: 512 ICO＋1408×232 BAN。フロストリッジ流用解除。`134`）
