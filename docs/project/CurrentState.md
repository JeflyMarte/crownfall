...
2026-09-02（**遺跡遠征 v2**: 5F装備ステーション・`rogue_*`専売・L/M大幅増。10Fは仲間/回復のみ。`137`更新。**GO 待ち**）
2026-09-02（**遺跡遠征 Decision 草案**: 単騎Lv1・50F・10Fピック・30F中ボス・50F限定装備・キャラ別ビンゴ。`137`／Decision Log。**GO 待ち**→Impl A から）
