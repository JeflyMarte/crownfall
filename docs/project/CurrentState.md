...
<<<<<<< HEAD
2026-08-27（**征討名「地図なき主」＋雰囲気／敵案A**: アルバーク。既存霜敵の再配置。案AはオーナーGO待ち。`128`§3.1）
...
2026-08-27（**征討再定義 Decision GO**: イベント常設・20F固定・降臨N・エンシェント・⑤クリア後一括・パイロット1本。`128`／`05_Biomes §2.1`。対象 id 指定待ち→Impl）
>>>>>>> cursor/engineer-warhammer-2ee2
