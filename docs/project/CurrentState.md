...
=======
2026-07-29（**鍛冶完了ポップ差分**: 強化／錬成後に `炉研ぎ/装備Lv` と攻撃・防御・HP を `前 → 後` 表示。要実機）
2026-07-29（**鍛冶完了ポップUX**: レアロゴを装備一覧サイズへ（PanelContainer伸長修正）。説明／セット文を短縮＋Arbitrary折返し。要実機）
>>>>>>> origin/cursor/forge-complete-rarity-desc-c519
...
2026-07-23（**P3-CODEX-GUIDE-003**: 手引きに調査室／オトモ／野外・イベントDG／放浪を追加。ダメージ・脅威・状態異常をユーザー向け改稿）
