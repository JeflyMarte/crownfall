...
## Last Update
2026-09-25（**iOS 1.0.9 build41 releaseエクスポート＋Xcode適用**: 極限任務＋王痕育成＋ニーナ初片手引き＋装備名2段ほか。PCK 545MB・ja.lproj。要 Archive→Upload→Connectで1.0.9提出）
2026-09-24（**キャラ名2段化**: 上＝名前全文／下＝一覧・王痕。右はみ出しと省略を両立）
2026-09-24（**キャラ名省略を廃止**: 横幅は維持しつつ ellipsis をやめフォント縮小のみで全文表示）
...
2026-09-21（**王痕初回片のニーナ手引き**: 拠点戻り後に王痕画面へ強制遷移→書籍3ページ。パーティ先頭。既存片持ちは既読heal）
2026-09-20（**Featured説明のタイトル重複削除**: バナー上タイトルがある極限は説明欄タイトル行を非表示）
2026-09-20（**最終バグチェック**: smoke PASS／極限・入場・王痕・手引き GUT PASS。全GUT 1877/1883・失敗6は装備／宝箱系の既知ノイズ。極限変更由来のP0/P1なし）
2026-09-20（**極限常設出現**: 日替わり廃止。解放後は EX-01〜10 をいつでも挑戦）
2026-09-20（**極限一覧をEX番号順**: debug全日開放時も EX-01→10。難易度順廃止）
2026-09-20（**極限表記統一**: `EX-XX　極限任務　【任務名】`。選択／戦闘／結果／tres同期）
2026-09-20（**iOS debug再エクスポート＋Xcode適用**: EX-07ペット主砲／極限表記ほか先端。PCK 545MB・ja.lproj。要実機再インストール）
2026-09-20（**EX-07ペット主砲**: 必殺チャージ抑制廃止。人間与ダメ×0.70／ペット×1.10。指令は同職なし）
2026-09-20（**極限表記を【極限任務】に**: 戦闘／結果／選択の「1-1」を置換。本編据置）
2026-09-20（**結果画面獲得報酬に王痕片**: 合計>0でICO表示。王痕片ICO差し替え）
2026-09-20（**戦闘レジェンド罠ICO縦ずれ修正**: 右下は他ステと同寸1枠。頭上マークは据置）
2026-09-20（**EX-03スキル耐性**: 反射廃止。スキル与ダメ×0.40／通常・罠・状態は据置）
2026-09-20（**EX-02常時群れ**: 通常COMBATはすべて群れ＋体数+1。出現率加算は廃止）
2026-09-20（**iOS debug再エクスポート＋Xcode適用**: 極限群れ緩和誤爆修正ほか先端。PCK 545MB・ja.lproj。要実機再インストール）
2026-09-20（**極限群れ緩和誤爆修正**: モーンゲート序盤緩和を本編のみに限定。EX-02の群れ増加が効く。GUT swarm_escorts）
2026-09-20（**iOS debug再エクスポート＋Xcode適用**: 極限日替わり／入場硬化ほか先端。PCK 545MB・ja.lproj。要実機再インストール）
2026-09-20（**入場経路硬化**: 極限タブ空で本編 Featured 残留→誤入場を防止。空 id の DataRegistry 読込を拒否。入場スモーク GUT 追加）
2026-09-20（**極限日替わり1任務**: 朝5時JSTでEX-01〜10固定ローテ。出現中は無制限。debug時は全日）
2026-09-20（**極限とは？手引き追加**: 極限任務タブにニーナ手引き。降臨／征討／無限と同列。図鑑 SYS-G015）
2026-09-20（**極限副経路を共通ダメージ適用へ**: 仕掛け／パッシブ追撃／余波／枯翠／虚潮も障壁・反射を適用）
2026-09-20（**極限EX-03反射／EX-08障壁**: Decision `145` 更新。03=`damage_reflect`・08=`shell_pressure`。旧長期ランプ／非会心廃止）
2026-09-20（**王痕ステ表示を元+上昇に**: 「現在のステータス」を `1200 +36` 形式へ）
2026-09-20（**王痕画面に現在ステータス**: 効果枠と次の王痕の間に実数値枠。王痕倍率込み）
2026-09-20（**極限L/Mドロップ+10pt**: 極限のみ LEGENDARY 別枠10%／ボス再クリア神話11%。本編据置）
2026-09-20（**極限任務一律10F**: Decision `143` 上書き。EX-01〜10 の floor_count／room_count＝10。指令タイム・TUNING据置）
2026-09-20（**限界突破結果はみ出し修正**: パッシブ効果を ARBITRARY 折り返し＋Scroll SHOW_NEVER。装飾枠左右余白増）
2026-09-20（**極限説明文更新**: 指令見出しに王痕片入手を明記／CLEAR★行を削除）
2026-09-20（**結果画面極限／王痕片ICO**: 探索情報に極限・★・記録・王痕片アイコンを追加）
2026-09-20（**極限指令説明**: Featured に「以下を達成すると報酬アップ」を追加。Gameplay 不変）
...
2026-09-20（**王痕育成 UI Polish**: 方針ボタン選択状態明確化／具体効果を方針パネルへ／必殺技覚醒分離／V MAX圧縮。Gameplay・Save不変）
...
2026-09-18（**王痕育成 Phase 2 専用UI**: `RoyalMarkScene`＋拠点左メニュー導線。Equipment は Rank 参照のみ。GUT UI 10＋本線 27／Extreme 16／smoke PASS。feature `cursor/royal-mark-144`・**main未マージ**）
...
2026-09-13（**征討手引きの固有名削除を横展開**: イベントとは？／図鑑SYS-G004・WORLD-G041も同じ方針）
2026-09-13（**征討とは？手引き追加**: イベントタブで降臨とは？の隣。3ページ・自動初回なし。要実機）
2026-09-13（**降臨／征討名を大きく太く**: バナー／Featuredを28〜26px優先＋合成太字。要実機）
2026-09-13（**降臨／征討BANの黒抜け修正**: strip生成の白マット除去で明るい絵が透明→後ろの黒が見えていた。不透明再生成＋バナー文字の強シャドウ緩和。要Godot再インポート／シーン再入場）
2026-09-13（**降臨／征討にボス名を付与＋BAN名板除去**: 例【潮脈王ネレイオン・デプス】降臨。征討／降臨バナーから中央名板・金枠を外し雰囲気画のみ。要実機）
2026-09-13（**降臨を15Fに統一**: 時環／境界／潮脈王。タイトルは【本体】降臨・征討。要実機で長さ確認）
2026-09-13（**征討／降臨タイトルを【本体】形式へ**: 例【境界の番】降臨・【地図なき主】征討。2色Helperを征討対応）
2026-09-13（**潮脈王戦闘BGをオーナー生成版へ**: 通常→Early/Late、ボス→Boss。1024×1536 cover。要 debug 再エクスポート）
2026-09-13（**潮脈王 Late戦闘BGを引き構図へ**: 寄り船倉を差し替え。1024×1536。要 debug 再エクスポートで中盤確認）
...
2026-09-06（**仕掛け印: 正方形フレーム＋残発は枠外上／ICO拡大52**: 縦伸び枠を解消。要実機）
2026-09-06（**機巧士仕掛け印を拡大＋残発を上表示**: ICO 40px・数字はアイコン上。要実機）
2026-09-06（**展示室スキル名を1行縮小表示**: 途中改行廃止。長い名前はフォント縮小。要実機）
2026-09-06（**征討ステージ改名＋星炉装備プール火山化**: アストラ・スパイア／カルデラ。霜プール流用解除。要実機）
2026-09-06（**第2弾範囲再点検**: 機巧／征討／発掘。関連GUT全PASS。機能ブロッカーなし。提出前は潮脈王フラグOFF必須）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 錬成スクロール／展示室スキル折り返しほか先端。PCK 529MB・ja.lproj。要実機再インストール）
2026-09-06（**錬成左一覧スクロール＋展示室スキルはみ出し**: 短押し選択／スキル名1行7文字折り返し。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 征討進入行フロア／推奨Lv・天望Early群れ位置ほか先端。PCK 529MB・ja.lproj。要実機再インストール）
2026-09-06（**征討進入行にフロア／推奨Lv＋天望Early群れ位置下げ**: 進入カードを本編章行と同型。地図なき主F1–14複数敵のみ足元+0.06。要実機）
2026-09-06（**錬成左一覧スクロールGUTを仮想リスト対応**: 子数ではなく entry_count／content_height で検証）
2026-09-06（**鍛冶錬成左一覧を仮想スクロール化**: 見える行だけカード生成。デバッグ大量所持でも固まりにくく。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 天望BGオーナー差し替えほか先端。PCK 529MB・ja.lproj。要実機再インストール）
2026-09-06（**天望戦闘BGをオーナー生成版へ差し替え**: Early/Late/Boss・1024×1536・他BG並み密度。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 天望BG空密度揃え／錬成軽量化／MCP除外ほか先端。PCK 529MB・ja.lproj。要実機再インストール）
2026-09-06（**天望戦闘BG 空の画素密度揃え**: Early/Late/Boss 再生成。床・柱と同スケールの空／雲。要実機）
2026-09-06（**鍛冶錬成タブ体感改善**: 左一覧チャンク生成＋素材候補走査1回化。要実機）
2026-09-06（**iOS起動ハング対策＋再エクスポート**: 実機PCKからMCP addon/autoload除外。BGMはstop後に差替。PCK 529MB。要Xcode再ビルド／再インストール）
...
2026-09-06（**セルディオン序盤ボス小幅弱体**: ATK125／咆哮×0.6／F1重み1.6。エリート据置。要実機）
2026-09-06（**戦術説明全文表示＋機巧士改名**: 攻撃特化折り返し。ブラン→バルガント／オルソ→アンヴィ／トリム→ブリキ。要実機）
2026-09-06（**天望戦闘BGをドット質感へ寄せ**: 構成維持・他戦闘BG質感に合わせて再生成。要実機）
2026-09-06（**鍛冶錬成左一覧スクロール修復**: 下帯オミット時 MainSplit 直置き。要実機）
2026-09-06（**天望の塔 専用戦闘BG**: Early/Late/Boss 3枚。境界廊流用解除。開けたステージ。`141`）

2026-09-06（**ダンジョンバナーから CLEAR 削除**: Featured／一覧見出しの CLEAR をやめ、章行のみ残す。要実機）
2026-09-06（**キャラ詳細入場／◀▶ 軽量化**: 所持グリッド遅延＋切替デバウンス＋Idle 裏読み。要実機）
2026-09-06（**DungeonScene 辞書パース修復**: 潮脈王取り込みで欠けた `blackshore_abyss` エントリを復元。要実機）
2026-09-06（**潮脈王降臨 Impl／第3弾検証ON**: `nereion_flagship`・潮脈の契・2/5/8/11。BAN/ICO仮流用。要実機）
2026-09-06（**展示室スキル箱を細幅化**: 幅150・ステ下右寄せ。Panel 固定で再膨張防止。要実機）
2026-09-06（**必殺ICO枠を初期5装飾枠へ統一**: 追加キャラ必殺11を デッドアイ装飾枠テンプレへ差し替え。初期5／機巧3は据置。要実機）
2026-09-06（**展示室スキル箱を内容フィット縮小**: 空の高い枠をやめ、スキル名は折り返しではみ出し防止。要実機）
2026-09-06（**ダンジョン選択 CLEAR 位置統一**: メイン／イベントとも右端表示。タイトル直後インライン廃止。要実機）
2026-09-06（**潮脈王降臨 Decision GO／第3弾**: ネレイオン・デプス・2/5/8/11・潮脈の契。Implはアップデート第3弾。`140`）
2026-09-06（**機巧作動フィードバック案A+T1**: ログ「〜が作動した！」／頭上「種作動！」／ダメ数字を琥珀。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 星炉雑魚差し替え／必殺顔全体表示ほか先端。PCK 531MB・ja.lproj。要実機再インストール）
2026-09-06（**星炉雑魚差し替え＋必殺顔全体表示**: プールを鉱熱寄りに刷新（天望雑魚と分離）。必殺カットイン顔は COVERED→CENTERED。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 機巧作動EF軽量化ほか先端。PCK 531MB・ja.lproj。要実機再インストール）
2026-09-06（**機巧作動EF軽量化**: テロップをダメ数字プール流用。頭上更新は対象スロットのみ（全再構築＋tint省略）。要実機）
2026-09-06（**機巧仕掛け作動EF案A**: 作動時に敵フラッシュ＋「作動・種」テロップ＋印パルス。要実機）
2026-09-06（**戦闘前部屋残像＋征討レイブン希少**: 黒幕中に部屋アートflush。レイブン `spawn_weight_mult=0.2`。トラップEFは要相談）
2026-09-06（**必殺ICO枠をデッドアイ系に統一＋ブラッドドレイン説明**: 新規11を鋼＋シアン枠へ。吸血は自己強化・通常攻撃吸収と明示。要実機）
2026-09-06（**iOS debug再エクスポート＋Xcode適用**: 必殺ICO枠／機巧説明／キャラ切替／敵即時表示／図鑑Scrollほか先端。PCK 531MB・ja.lproj。要実機再インストール）
2026-09-06（**戦闘敵即時表示／デバッグ装備MAX／単体敵縮小／図鑑スクロール**: 黒幕中flush・防具装もLvMAX・単体0.92・一覧PASS短押し。要実機）
2026-09-06（**必殺ICO枠＋機巧説明＋キャラ切替**: 新規必殺11に金枠。機巧説明／持続を具体化。◀▶軽量化・一覧はパーティ順。要実機）
2026-09-05（**第2弾監査フォロー**: 星炉解放ポップ／発掘チャリン日跨ぎ・オーバーレイ再試行。手引き旧文は済。要実機）
2026-09-05（**第2弾範囲バグ点検**: 機巧／征討／発掘。征討手引き旧文を修正。P2系GUTはPASS・資産OK。要実機チェックリスト）
2026-09-05（**iOS debug再エクスポート＋Xcode適用**: 征討タブ修正・デバッグ機巧士込み。PCK 531MB・ja.lproj。要実機再インストール）
2026-09-05（**征討タブ誤遷移＋デバッグ機巧士**: イベントで征討押下で main へ飛ぶ修正。デバッグ開始／継続で機巧士3をロスター付与。要実機）
2026-09-05（**iOS debugエクスポート＋Xcode適用**: 実機テスト用。`libgodot.ios.debug`・タイトル／拠点デバッグ可。提出は `--export-release`。要実機）
2026-09-05（**iOS 1.0.3 build21 releaseエクスポート＋Xcode適用**: パーティ編成即確定ほか先端込み。PCK要確認・ja.lproj。要実機）
2026-09-05（**パーティ編成即確定**: フッター「保存」廃止。入れ替え／おすすめ／陣形確定で即反映。「パーティ保存」プリセットは残置。要実機）
2026-09-05（**招待状機巧士NEW＋図鑑手引き**: Featured/プールにNEW！。発掘・機巧士手引き追加／職一覧・特権強化文更新。要実機）
2026-09-05（**特権強化フレーム２**: 新フレーム差替。リセット／決定は文字のみ重ね。要実機）
2026-09-05（**特権強化決定ボタン視認性**: 焼込の薄い決定を不透明金枠ボタンで上書き。要実機）
2026-09-05（**特権強化フレームUI**: フレーム重ね。−／＋ドラフト、決定でセーブ。要実機）
2026-09-05（**発掘魔晶石発光**: 結果の大結晶／帯アイコンと戦闘の岩に紫グロー脈動。要実機）
2026-09-05（**発掘ランキング見出し画像**: 「発掘ランキング」「ダメージ順」文言をやめ、ダメージランキング.pngバナー表示。要実機）
2026-09-05（**発掘結果フレーム２**: 「魔晶石」焼込なし版へ差し替え＋再インポート。獲得数をアイコン右空きへ。要実機）
2026-09-05（**発掘結果獲得石中央寄せ**: 結果フレーム再取込。獲得数を画面中央へ。要実機）
2026-09-05（**発掘結果位置調整**: 結果フレーム差し替え。獲得石をアイコン右へ／ダメ・記録更新を上へ。戦闘キャラさらに下。要実機）
2026-09-05（**発掘結果フレーム**: Downloads結果フレームに合わせ数値／戻る／ランキングを重ね配置。要実機）
2026-09-05（**発掘→拠点チャリン**: 右上魔晶石へCurrencyGainFx＋カウントアップ。要実機）
2026-09-05（**発掘ダメ±15%**: 確定時のみ乱数。選択は中央値表示。Decision127更新）
2026-09-05（**発掘結果UI**: 上部タイトル非表示。結果バナー黒マット透過。要実機）
2026-09-05（**発掘戦闘カットイン**: TAP→スキルカットイン→ダメEF。ヘッダ／上スキル名撤去。キャラ下へ。入口点滅。？上／所持石微下。要実機）
2026-09-05（**発掘選択UI位置**: ？右上／所持石上／ランキング下。要実機）
2026-09-05（**発掘ランキング**: 結果バナー適用。ダメージ履歴ランキング画面。選択／結果から遷移。入口さらに左。要実機）
2026-09-05（**発掘ヒット強化**: ヒットEF大型化／飛び散り量をダメ連動。拠点入口さらに左・調査室上。要実機）
2026-09-05（**発掘戦闘演出**: TAP中央大型／WALK待機＋攻撃モーション／岩破碎飛散。拠点入口左寄せ・調査室上。要実機）
2026-09-05（**発掘UI調整**: 拠点入口右寄せ／調査室上へ。所持石右上。発掘確認POP。戦闘TAP攻撃。岩白マット透過。要実機）
2026-09-05（**発掘選択UI整え**: レターボックス黒／戻る・所持石・？をフレーム位置へ。初回ニーナガイド＋再表示。要実機）
2026-09-05（**魔晶石発掘選択UI重ね直し**: 自前枠をやめ、フレーム焼込位置に操作／数値のみ配置。要実機）
2026-09-05（**魔晶石発掘レイアウト**: 拠点円形入口＋選択フレーム背景／金枠行／中央発掘ボタン。要実機）
2026-09-05（**次戦闘で前敵死体フラッシュ修正**: 暗転 defer 時に旧スプライトを消す。要実機）
2026-09-05（**発掘入口位置＋デバッグ無制限＋星炉BAN名板**: ニーナ下／調査室上。debug時回数制限解除。`BAN_DG_RedForge`名板を標準幅へ。要実機）
2026-09-05（**機巧仕掛け頭上視認性**: 罠ICOに色板＋付与時パルス。レジェンドにも印を含める。要実機）
...
2026-09-05（**リモート取り込み（遺跡遠征除く）**: 機巧ICO／罠BAL／発熱Pack A／エンシェント案D。abyss天候は本線済みでスキップ。Decision 衝突回避で案D=`139`。要実機）
2026-09-05（**ニーナ吹き出し幅**: 308→400。降臨告知の不自然な折り返し緩和。要実機）
2026-09-05（**キャラ別必殺 Impl**: スターター＋助っ人の必殺分岐接続。漢字5＋カタカナ。火鷹は反動なし。`138`／GUT PASS。要実機）
2026-09-05（**キャラ別必殺 Decision GO**: ビルドテーマ整合・漢字名5＋カタカナ混在。火鷹は反動なし。機巧士据置。`138`）
2026-09-02（**キャラ差替えスキル枠パイロット**: 機巧士3・Lv40×1。棘の雨／余熱波／継ぎ目爆。`137`）
2026-09-02（**アルバーク戦闘ICO更新**: ターン＝ドット idle 直出し。白静寂／地図なき突進＝白神龍系に差し替え。`132`）
2026-09-02（**アルバーク図鑑ART**: ドット（白神龍）に合わせて肖像差し替え。骨甲四足版→神龍系。`132`）
2026-09-01（**魔晶石発掘 BG**: 選択／対石／結果＋岩スプライト生成・配線。`UI_BG_CrystalExcavate*`）
2026-09-01（**魔晶石発掘 Impl**: 案A・日次1・上限300・日課上入口・選択→対石→結果。`127`／GUT＋headless PASS。要実機）
2026-08-31（**機巧士スキル専用ICO**: キット7＋必殺3＋職フォールバック。128px接続。`126`）
2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）
2026-08-31（**機巧士やや強化 GO＋接続**: スパイク作動×0.65／甲砕中罠×1.15。`126`／BAL-001）
2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）
2026-08-31（**フォージ戦闘ICO**: ターン＋スラグ吐息／炉床震動。エルディオン流用解除。`135`）
2026-08-31（**発熱対策パッケージA**: モバイルループ追加抑止・正規化キャッシュ・ダメ数字プール／上限。iOS確認リスト追加）
2026-08-31（**エンシェント案D**: 地力引き上げ＋単品パッシブ12種。3部位加護据置。`139`）
2026-08-31（**アルバーク戦闘ICO／図鑑**: ART＋ターン＋白静寂／地図なき突進。エルディオン流用解除。`132`）
2026-08-31（**フォージ戦闘ICO**: ターン＋スラグ吐息／炉床震動。エルディオン流用解除。`135`）
2026-08-31（**星炉火口 専用DG ICO／BAN**: 512 ICO＋1408×232 BAN。フロストリッジ流用解除。`134`）
2026-08-31（**星炉火口 専用戦闘BG**: Early/Late/Boss 3枚。Motif B。BrokenMarsh流用解除。`134`）
2026-08-30（**星炉の滓 専用ICO**: 武5＋防＋飾 128px透過。炉熱・熔渣テーマ。流用解除）
2026-08-30（**征討セット星炉の滓 GO＋接続**: 炎上持続×1.30／炎上中与ダメ×1.12。武5＋戦鎚。`136`）
2026-08-30（**征討 Boss フォージ降臨帯**: HP3900/ATK248・スラグ吐息×0.60。アルバーク同帯。`135`）
2026-08-30（**征討2 星炉火口 GO＋接続**: 火山テーマ・20F・天望クリア後解放・炎天天候。セット後続。`134`）
2026-08-30（**フォージ・ドルミエント図鑑ART**: 専用肖像接続。エルディオン流用解除）
2026-08-30（**征討 天候W-A＋雑魚Lv帯**: 吹雪0・晴れ/霧寄り。雑魚50/54/58。`133`）
2026-08-30（**征討 日次制限＝無制限**: 回数ゲートなし確定。`128` 001-7）
2026-08-30（**征討 Boss アルバーク降臨帯**: HP3900/ATK248・白静寂×0.60。ヴァル超え・クロノス未満。`132`）
2026-08-30（**征討 Hard/NM**: 天望の塔も降臨同型 TabsRow N/H/NM・自由選択。`128` 001-5／`P3-DG-APEX-TIER-001`）
2026-08-30（**征討 専用DG ICO／バナー**: 天望の塔 512px ICO＋1408×232 BAN。境界廊流用解除）
2026-08-30（**名拒みの冠 専用ICO接続**: 武5＋防＋飾 128px透過PNG。流用解除。`131`）
2026-08-30（**征討セット名拒みの冠 GO＋接続**: 武5（戦鎚込）＋防＋飾。付与×1.25／敵バフ持続×0.75。`131`）
2026-08-30（**征討セット案C詰め**: 名拒みの冠 — デバフ付与×1.25／敵バフ持続×0.75。`131` 承認待ち）
...
2026-08-28（**無限11Fフリーズ再対策／統合＋main**: 明け後の天候VFX・Late背景・敵loadを2フレーム分割。分かれ道にキャプション。GUT 1621 PASS。要iOS実機で虚脈11F）
2026-08-28（**戦鎚専用ICO GO＋接続**: 梯子14本 128px透過PNG。IconPaths更新。`129`）
2026-08-28（**征討ステージを案Cへ**: 高塔「天望の塔」・空テーマ。案B混成却下。GO待ち。`128`§3.1）
2026-08-27（**戦鎚梯子A GO＋接続**: R0–R2章梯子12＋破砕L「継ぎ目穿ちの戦鎚」。各章プール接続。`129`／`95`）
2026-08-27（**戦鎚武器種 GO＋接続**: 表示＝戦鎚／`hammer`。破砕特性。機巧士＝戦鎚・双剣（弓外す）。COMMON `iron_warhammer`。`129`／`07`／`126`）
2026-08-27（**征討名「地図なき主」**: アルバーク。案A雪山は却下済。`128`）
2026-08-27（**征討パイロット＝アルバーク確定**: `north_reach`。二つ名・セット装備は後続。`128`）
2026-08-27（**征討再定義 Decision GO**: イベント常設・20F固定・降臨N・エンシェント・⑤クリア後一括・パイロット1本。`128`／`05_Biomes §2.1`）
2026-08-27（**機巧士見た目・レア GO**: ブラン★4ガスマスク／オルソ★2作業着少女＋大金槌（見た目）／トリム★3メガネ髭小太り。`126`§6.1）
2026-08-27（**機巧士トリム必殺差し替え GO**: フルアーム・カスケード＝全体薄ダメ＋スパイク一斉設置（最大3）。旧・既存印即作動は廃案。`126`§6.3）
2026-08-27（**機巧士キャラ別必殺 GO**: フルアーム・カスケード／ブレイズ・オーバーロード／穿甲の極撃。`126`§6.3。Impl 後続）
2026-08-26（**iOS 1.0.3 build15 releaseエクスポート＋Xcode適用**: 1.0.2 はリリース済みのため short_version 1.0.3。N・R自動分解ほか先端込み。PCK 483MB・ja.lproj。要 Archive→Upload。Connect で **1.0.3** を作成して提出）
2026-08-26（**iOS 1.0.2 build14 releaseエクスポート＋Xcode適用**: N・R自動分解ほか先端込み。`--export-release`・PCK 483MB・ja.lproj。要 Archive／実機）
...
2026-08-26（**iOS 1.0.2 build10 releaseエクスポート＋Xcode適用**: 先端（GUT修正・曜日再挑戦日次・特典コード4種ほか）。`--export-release`・PCK 482MB・ja.lproj。要 Archive／実機）
...
2026-08-26（**装備仮想スクロール・袋400・神話錬成可／統合＋main**: 所持一覧は見えている行のみ生成。武+防+飾400。着脱差分パッチ・装備者キャッシュ。神話錬成可（×4 Gold）。要実機）
2026-08-26（**機巧士仕掛けマーク GO＋接続**: スパイク／スネア／ブレイク頭上ICO。残発表示。統合＋main）
2026-08-26（**機巧士キャラ3＋パッシブ GO**: トリム／ブラン／オルソ。先置きの棘／装炎の余熱／継ぎ目穿ち。ガチャ助っ人・BASE外。`126`§6.1／`93`。Impl 後続）
2026-08-25（**機巧士実装接続／統合＋main**: JobData・スキル7＋必殺・`EngineerTraps`・敵行動発火。キャラ3／専用ドット／L装備は後続。アップデート枠）
2026-08-25（**魔晶石発掘 Decision GO**: 案A・日次1・上限300・日課隣・必殺なし。選択→対石戦闘風→結果。`127`。Impl GO 待ち）
2026-08-25（**機巧士スキルキット GO**: 7技能確定（スパイク／ドリル／スネア／チャージ／ブレイク／スクラップ／バーン）。`126`／`94`／`06`／`07` 反映。実装はアップデート枠・未着手）
2026-08-25（**軽量モードB＋ヒットVFXプールC／統合＋main**: ヒット／必殺帯／紙吹雪を軽量モード連動。HitVfxPool で割当削減。GUT 1608 PASS。要実機）
2026-08-25（**機巧士 Decision GO**: テーマ＝罠／装炎／破砕。B案＝敵行動発火の仕掛け。装炎＝長CD＋炎上。武器双剣弓。`126`／`93`／`world/09` 反映。実装はアップデート枠・未着手）
2026-08-25（**UIアイコン解像度ダウン／統合＋main**: 敵行動順≤256・CHR／助っ人肖像≤512。ソース約133MB→16MB。GUT 1605 PASS。要iOS再ビルド・実機で行動順／顔の見た目）
2026-08-22（**設定・軽量モード／統合＋main**: 天候パーティクル・状態オーラ・帯VFX・ボス瓦礫を設定で抑止。既定オフ。GUT 1602 PASS。要実機でオン時の発熱感）
2026-08-22（**ユーザーメール調査（降臨回数）**: 降臨は仕様どおり日次無制限。曜日イベントは結果「再挑戦」が回数消費を踏まずすり抜け得る（Known Issues）。エンド／発熱要望はアップデート枠）
...
2026-08-11（**先端をiOS再エクスポート＋Xcode適用**: main先端（錬成Gold主材Lv帯ほか）・PCK 546MB。要実機Build／再インストール）
2026-08-11（**錬成Goldに主材Lv帯／統合＋main**: 素材帯×主材帯を乗算。高Lv主材＋安い素材の穴を塞ぐ。要実機）
2026-08-11（**先端をiOS再エクスポート＋Xcode適用**: main先端（影狩やや弱体・火鷹スキップ10%ほか）・PCK 546MB。要実機Build／再インストール）
2026-08-11（**影狩やや弱体＋火鷹スキップ10%／統合＋main**: HP/ATK/DEF・鎌・鈍化／スキル率を下げ、火鷹行動スキップ20→10%。要実機）
2026-08-11（**調査受取ポップにチケット表示／統合＋main**: 完全調査で当たった招待券等を受取結果に載せる。GUT PASS。要実機）
2026-08-11（**P1バグ4件修正／統合＋main**: クリア後章デフォルト／探索方針セーブ／ダンジョン選択タップ／満袋偽ドロップ。GUT 1571 PASS。要実機）
2026-08-11（**先端をiOS再エクスポート＋Xcode適用**: main先端（セルディオン速度1.1・モーンゲートN群れ2／罠再緩和ほか）・PCK 546MB。要実機Build／再インストール）
2026-08-11（**セルディオン速度1.1／統合＋main**: attack_speed 1.35→1.1。要実機）
2026-08-11（**結果 last_run 残留点検／統合＋main**: 全滅天候ヒント・outcome空の誤CLEAR・入場クリア強化。要実機）
2026-08-11（**モーンゲートN群れ2＋罠再緩和／統合＋main**: 全章群れ最高2・罠部屋20%／探索5%。要実機）
...
2026-08-11（**降臨エンシェント装備ドロップ修正／統合＋main**: 初回1個確定・再周回40%（一度に複数は出さない）。要実機）
2026-08-11（**降臨エンシェント装備1個固定／統合＋main**: ボス撃破ごと1個確定。要実機）
2026-08-11（**先端をiOS再エクスポート＋Xcode適用**: main先端（クロノス召喚削除・キャラ詳細フォーカス修正ほか）・PCK 546MB。要実機Build／再インストール）
2026-08-11（**クロノス・ウェーブ召喚削除／統合＋main**: クロックモス招集を外す。要実機）
2026-08-11（**キャラ詳細フォーカス取り違え修正／統合＋main**: Roster→Equipment を member id 渡し。GUT PASS。要実機）
2026-08-11（**先端をiOS再エクスポート＋Xcode適用**: main先端（プレイヤー向け文言点検・手引き／Wiki同期ほか）・PCK 546MB。要実機Build／再インストール）
2026-08-10（**手引き／Wiki文言総点検／統合＋main**: 5-5加入例外・天候・必殺ゲージ・DoT・罠解除・寄り道表記を現行同期。GUT PASS）
2026-08-10（**プレイヤー向け文言点検／統合＋main**: 設定セーブ・クレジット・ガチャ失敗・深層通知・鍛冶エラー・Biome／仮登録／手引きオミット語。GUT PASS）
...
| 課題 | 詳細 |
|---|---|
| イベント日次×再挑戦 | ~~結果「再挑戦」が日次未消費~~ → **解消**（P3-BUG-EVENT-RETRY-001）: 結果再挑戦も `can_attempt`／`consume`。降臨（limit=0）は無制限据置。手引きも曜日1回／降臨無制限を明記 |
