...
| 機能 | Task | 実装概要 |
|---|---|---|
| 縦長固定ビューポート | P3-UI2-003 / **P3-UI-SAFE-001** | 720×1280 固定（`canvas_items` / **`aspect=keep`**）。端末セーフエリアはレターボックスで足りない分だけ UI を内側へ（`SafeAreaHelper` / `SafeAreaPad`） |
