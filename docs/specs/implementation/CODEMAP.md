...
| | **バランス:** `BalanceConfig.gd`（STAT_SCALE・成長・Threat・**P3-BAL-OPENING-001** 敵グローバル倍率／味方ボーナス圧縮・**P3-BAL-CLEAR-EXP-001** CLEAR時EXP+25%・**P3-BAL-WEEKDAY-EVENT-REWARD-001** 曜日撃破EXP/Gold×2） |
