...
| RoyalMarkScene | `scenes/royal_mark/RoyalMarkScene.tscn` | `scripts/royal_mark/RoyalMarkScene.gd`（**王痕育成専用UI `144` Phase2**・キャラ管理導線・Rank III/V 強化表示） |
...
| `royal_mark/` | `RoyalMarkScene.gd`（**王痕育成専用UI `144` Phase2**・キャラ管理導線・Skill/Ultimate 強化行） |
