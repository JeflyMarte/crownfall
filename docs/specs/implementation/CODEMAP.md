...
| `gacha/` | **`GachaSystem.gd`**・**`GachaRarityConfig.gd`**（**P3-GACHA-008** ★2〜4・プール6体）・**`GachaScene.gd`**（P3-UI2-020・**P3-GACHA-002/003**・**P3-UI-GACHA**）・**`GachaUiTokens.gd`**・**`GachaUiHelper.gd`** |
