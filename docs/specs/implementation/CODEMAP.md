...
| `gacha/` | **`GachaSystem.gd`**（P3-D036b 単発/天井/還元・**P3-GACHA-001** ★4=20%・**P3-GACHA-004** 動的プール5体）・**`GachaScene.gd`**（P3-UI2-020 Header/BottomNav・**P3-GACHA-002** 固有名/来歴・**P3-GACHA-003** 立ち絵） |
