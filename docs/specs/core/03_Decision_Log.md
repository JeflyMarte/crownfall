...
## ボス圧力（セルディオン先行・詠唱全体の薄さ）（2026-07-31 — P3-BAL-BOSS-PRESSURE-001）

> **オーナー GO（F1＋F2・モーンゲートのセルディオンから）** — 4人パーティでボス行動前に削られる主因＝全体が詠唱付き＋スキル率40%＋激昂枠。
...
| P3-BAL-BOSS-PRESSURE-001-3 | **スコープ** — ①ボス先行。他ボス／エリート横展開は実機見てから | 最小差分で検証 |
