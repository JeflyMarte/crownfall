...
| P3-BAL-FORGE-002-2 | **錬成Gold** — `ceil(30 × 実上昇 × 帯倍率)`。帯＝素材Lv **1–20×1.0／21–50×1.5／51+×2.0** | 装備Lv加速の主経路を抑える |
...
| P3-BAL-FORGE-GOLD-HEAVY-001-3 | **錬成** — `60 × 上昇 × 帯倍率`（帯は FORGE-002 据置） | 全般シンク |
