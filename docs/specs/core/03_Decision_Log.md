...
| # | 決定 | 根拠 |
|---|---|---|
| P3-D152-1 | **対象＝武器・防具・装飾品**。各 Instance に `enhance_level`（0〜5）。実効値 = 装備Lv補正後 + `enhance_level`（武器=ATK / 防具=DEF+HP / 装飾=各整数ボーナス） | 2026-07-12 拡張。愛用装備への継続投資を全枠に |
...
| P3-UI2-018-2 | **強化タブ** — 左鑑定済み装備（武器/防具/装飾） / 右炉研ぎ詳細。`EquipmentEnhancer` が SSOT | P3-D152 拡張（2026-07-12） |
| P3-UI2-018-3 | **分解タブ** — ロック表示のみ（`分解 🔒`） | Alpha スコープ外 |
| P3-UI2-018-4 | **カテゴリ** — 武器 / 防具 / 装飾（生産・炉研ぎタブ共通） | 6レシピ分類 + 炉研ぎ対象 |
