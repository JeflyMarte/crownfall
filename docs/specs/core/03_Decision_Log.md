...
> **オーナー体験像確定・v2 追記（2026-09-02）。** 5F装備ステーション・`rogue_*` 専売・L/M 大幅増。10Fピックは仲間/回復に縮小。**GO 待ち**。

| # | 決定 | 根拠 |
|---|---|---|
| P3-DG-ROGUE-001-1 | 所持キャラ1人・**ラン内Lv1**・本編装備非持込 | オーナー指定 |
| P3-DG-ROGUE-001-2 | **50F固定**・ランダム部屋列 | オーナー指定 |
| P3-DG-ROGUE-001-3 | **5Fごと装備ステーション**（F5〜45・30/50除く）＋装備画面 | オーナー v2 |
| P3-DG-ROGUE-001-4 | 装備 id＝**`rogue_*` 専売**（本編他経路から取得不可） | オーナー v2 |
| P3-DG-ROGUE-001-5 | **L/M 抽選重み大幅増**（帯別表・pity） | オーナー v2 |
| P3-DG-ROGUE-001-6 | **F10/20/40** 仲間・回復ピック（装備の後）／**F30 中ボス** | v1 維持 |
| P3-DG-ROGUE-001-7 | **F50 クリア**で恒久装備1・**キャラ別5×5ビンゴ** | オーナー指定 |
| P3-DG-ROGUE-001-8 | `route_type=rogue`・他モードと分離 | 役割整理 |
| P3-DG-ROGUE-001-9 | SSOT — `137_RoguelikeExpedition.md` | Decision 本体 |
