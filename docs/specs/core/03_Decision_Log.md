...
## ギルド情報誌に天候効果を掲載（2026-07-29 — P3-UX-GUILD-WEATHER-FX-001）

> **オーナー指示** — 情報誌に雨／夜／霧などの効果が分かるようにしてほしい。

| # | 決定 | 根拠 |
|---|---|---|
| P3-UX-GUILD-WEATHER-FX-001-1 | **常設**「天候の効果」早見を情報誌本文に載せる | それぞれの天候をいつでも読める |
| P3-UX-GUILD-WEATHER-FX-001-2 | 天候スロットの「効果」欄に戦闘補正を追記 | いまの野外が天候のとき具体的に分かる |
| P3-UX-GUILD-WEATHER-FX-001-3 | 文言 SSOT=`CombatWeather`（P3-D101 数値と一致） | 図鑑／戦闘と食い違い防止 |
