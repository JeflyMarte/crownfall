...
### 更新（2026-07-23 — オーナー指示）

| # | 決定 | 根拠 |
|---|---|---|
| P3-BETA-SCOPE-8 | **`BETA_MOURNGATE_ONLY=false`** — メイン③以降も通常の直列解放に復帰。②は SURVEY≥70%＋①クリアを維持 | オーナー「β封鎖は解放」 |
| P3-BETA-SCOPE-9 | **寄り道／征討は引き続きオミット**（`SUB_DUNGEONS_PLAYABLE=false`） | β封鎖解除の範囲外 |
