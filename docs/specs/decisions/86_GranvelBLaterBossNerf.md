...
セルディオンは当初据置 → **`142_SerdionEarlyBossSoftNerf.md`（P3-BAL-SERDION-SOFT-001）で同型弱体**。イベントボスは据置。
...
| 4 | 据置（当時） — Hex×0.25／通常薙ぎ×1.0／大技×2.0／セルディオン咆哮×0.75／イベントボス（セルディオンは後に `142`） |
