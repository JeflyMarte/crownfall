...
| **極限任務** | **特殊条件＋極限指令の制約攻略** | **10F** | **極限任務タブ**・**日替わり1任務**（朝5時更新・メイン5 N 全クリア後） |
...
| P3-DG-EXTREME-001-14 | **日替わり1任務** — 朝5時 JST で EX-01〜10 を固定ローテ。出現中は回数無制限。debug_full_unlock 時は全日開放（2026-09-20） |
