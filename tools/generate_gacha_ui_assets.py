...
def main() -> int:
    ...
    save(draw_tab(220, 72, active=True), "UI_Gacha_Tab_Active.png")
    save(draw_tab(220, 72, active=False), "UI_Gacha_Tab_Inactive.png")
    ...
    save(draw_pull_button(320, 88, enabled=False), "UI_Gacha_Btn_10Pull_Disabled.png")
    save(draw_ribbon(), "UI_Gacha_Ribbon_SR.png")
