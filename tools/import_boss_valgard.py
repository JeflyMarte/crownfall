#!/usr/bin/env python3
"""Import Valgard boss dots + codex art from ~/Downloads.

Sources:
  ~/Downloads/境界の番ヴァルガード.zip  (PixelLab animations)
  ~/Downloads/境界の番ヴァルガード.png  (codex key art)

Outputs:
  assets/battle/bosses/BOSS_Valgard_Sheet.png
  resources/animation/BOSS_Valgard.tres
  assets/codex/enemies/ART_BOSS_Valgard.png
  assets/ui/combat/enemy_icons/ICO_ENM_Turn_Valgard.png
  wiki/docs/assets/monsters/ART_BOSS_Valgard.png (mirror)
"""
...
ZIP_STEM_NFC = "境界の番ヴァルガード"
OUT_SHEET = ROOT / "assets/battle/bosses/BOSS_Valgard_Sheet.png"
OUT_TRES = ROOT / "resources/animation/BOSS_Valgard.tres"
OUT_CODEX = ROOT / "assets/codex/enemies/ART_BOSS_Valgard.png"
OUT_TURN = ROOT / "assets/ui/combat/enemy_icons/ICO_ENM_Turn_Valgard.png"
OUT_WIKI = ROOT / "wiki/docs/assets/monsters/ART_BOSS_Valgard.png"
WORK = Path("/tmp/crownfall_valgard_import")
...
def write_tres(meta: list[tuple[str, bool, int, int]]) -> None:
	...
	lines = [
		...
		"",
		'[ext_resource type="Texture2D" path="res://assets/battle/bosses/BOSS_Valgard_Sheet.png" id="1_sheet"]',
		"",
	]
	idx = 0
	atlas_ids: list[str] = []
