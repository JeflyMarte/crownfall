#!/usr/bin/env python3
"""ep03: 16:9横＋下バナー＋文単位同期テロップを焼き込み。"""
...
VOICE = ROOT / "docs/devlog/yt_ep03/voice"
EXPORT = ROOT / "docs/devlog/yt_ep03/export"
CHAR = ROOT / "docs/devlog/yt_ep01/assets/zundamon/zundamon_stand.png"
SRC = EXPORT / "crownfall_ep03_silent.mp4"
AUDIO = EXPORT / "full_narration.wav"
OUT = EXPORT / "crownfall_ep03_yukkuri.mp4"
...
def main() -> int:
    if not SRC.exists():
        raise SystemExit(f"missing {SRC} — run shot runner + encode first")
    if not AUDIO.exists():
