...
const DUNGEON_CODEX_META: Dictionary = {
	...
	"mistfen_depths": {
		"location": "封緘書庫下・ミストフェン深部",
		"exploration_theme": "菌糸の書庫・征討調査",
		"related_history": ["HE-003", "HE-004"],
	},
	"thunder_peak": {
		"location": "サンダーピーク火口",
		"exploration_theme": "灰雲と燼竜・征討調査",
		"related_history": ["HE-004"],
	},
	"blackshore_abyss": {
		"location": "ブラックショア外洋・沈没旗艦下",
		"exploration_theme": "潮脈の巨体・征討調査",
		"related_history": ["HE-004", "HE-005"],
	},
	"red_forge_depths": {
	...
	"cosmic_rift": {
		"location": "エルダの裂け目（日次短編）",
		"exploration_theme": "濃いエルダ環境・コズミックダック",
		"related_history": ["HE-001"],
	},
	"crown_rookery": {
		"location": "宝冠レイヴンの塒（日次短編）",
		"exploration_theme": "遍在希少種・装備回収",
		"related_history": ["HE-007"],
	},
}
