...
const STARTER_PROFILES: Dictionary = {
	...
	"adventurer_2": {
		...
		"backstory": (
			...
			+ "触媒器で属性反応を整える手際は、ギルドでも「万象の触媒」と覚えられている。\n"
			+ "知恵をひけらかさず、「手伝わせてくれ」と静かに立つ。"
		),
		"record_note": "「万象の触媒」の通称は触媒班から定着。",
		"rarity": 3,
	},
	"adventurer_3": {
		"hometown": "アイアンヘイブン",
	...
	"adventurer_4": {
		...
		"backstory": (
			...
			+ "攻撃に毒・出血・炎上を絡める戦いぶりは「毒牙」と呼ばれ、ギルドの随伴訓練舎でジャックの世話係を務めていた一人でもある。\n"
			+ "隊への合流はジャックとの再会でもある。「ジャックと一緒に来たよ」——その一言に、職能と友情が重なる。"
		),
		"record_note": "ジャック世話係経歴あり。共鳴記録は訓練舎台帳に残る。「毒牙」は俗称。",
		"rarity": 3,
	},
}
