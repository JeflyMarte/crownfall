...
const STARTER_PROFILES: Dictionary = {
	...
	"adventurer_1": {
		...
		"backstory": (
			...
			+ "毒薬を塗った矢じりを丁寧に仕込み、観察と一撃のあいだを往復する。\n"
	...
	"adventurer_2": {
		...
		"backstory": (
			...
			+ "戦闘に入るたび味方へ応急の回復薬を配る手際は、ギルドでも「野戦調合」と覚えられている。\n"
	...
	"adventurer_3": {
		...
		"backstory": (
			...
			+ "反撃の間合いを測る構えは、境界守の古い教練の名残だと言われるが、"
