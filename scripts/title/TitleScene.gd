...
## タイトル（つづきから / はじめから）— P3-INTRO-001。

const HOME_SCENE: String = "res://scenes/base/BaseScene.tscn"
const INTRO_LORE_SCENE: String = "res://scenes/intro/IntroLoreScene.tscn"
const BG_PATH: String = "res://assets/ui/UI_BG_Title.png"
...
func _build_ui() -> void:
	...
	spacer_top.size_flags_stretch_ratio = 2.2
	root.add_child(spacer_top)

	var brand := Label.new()
	brand.text = "CROWNFALL"
	brand.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	UiTypography.apply_display(brand, 36, UiTypography.COLOR_GOLD)
	...
	spacer_bot.size_flags_stretch_ratio = 0.7
