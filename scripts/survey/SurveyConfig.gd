...
## P3-SURVEY-DISPATCH-EXP-001／P3-BAL-SURVEY-DUNGEON-EXP-001 — 戦闘員向け EXP。
## 参照＝対象 DG 完走相当（雑魚＋ボス・撃破×1.5・クリア+25%）。
## 簡易＝×1.0／本格＝×3.0。スタッフ／ペットは対象外。
const EXP_RATIO_SHORT: float = 1.0
const EXP_RATIO_STANDARD: float = 3.0
