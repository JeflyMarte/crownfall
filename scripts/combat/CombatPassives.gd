...
const _DEFS: Dictionary = {
	...
	"eq_serdion_ward": {
		"display_name": "霊廟の守護",
		"category": "armor",
		"description": "被弾時、HPが半分未満なら自身に防御を付与する（再使用10秒・防御中は再付与しない）。",
		"trigger": "on_hit_taken",
		"condition": "self_hp_below", "value": 0.5,
		"effect": "apply_status", "status_id": "guard", "target": "self",
		"skip_if_status_active": true,
		"skip_status_id": "guard",
		"cooldown": 10.0,
	},
	"eq_mourngate_royal": {
		"display_name": "王家の覇気",
	...
	"eq_bulwark_role": {
		"display_name": "盾役の構え",
		"category": "armor",
		"description": "敵の注目を大きく集める。前列で被弾すると防御をまとい再度注目を集める（再使用12秒・防御中は再付与しない）。",
	...
	"eq_abyss_mirestaff": {
		...
		"category": "weapon",
		"description": "被弾時に霧ガード（被ダメ半減）を付与する（再使用14秒・防御中は再付与しない）。",
		"trigger": "on_hit_taken",
		"condition": "always",
		"effect": "apply_status",
		"status_id": "guard",
	...
	"eq_wpn_vanguard_war_bow": {
		"display_name": "狙印の猛矢",
		"category": "weapon",
		"description": "標的の敵へ与ダメ +20%。攻撃時25%で標的を付与（RG標的）。",
		"outgoing_vs_status_mult": 1.20,
		"outgoing_vs_status_ids": ["mark"],
		"trigger": "on_attack",
		"condition": "always",
	...
	"eq_wpn_aegis_line_sword": {
		"display_name": "応撃の戦剣",
		"category": "weapon",
		"description": "戦闘開始時に反撃チャージ+1。反撃ダメージ +30%。敵の注目も集めやすい（VGカウンター）。",
	...
	"eq_set_chronos_weapon": {
		"display_name": "時環の刻・武器",
		"category": "weapon",
		"description": "スキル再使用時間 ×0.94。",
		"skill_cd_mult": 0.94,
	},
	"eq_set_chronos_armor": {
		"display_name": "時環の刻・鎧",
		"category": "armor",
	...
	"eq_set_chronos_acc": {
		"display_name": "時環の刻・宝珠",
		"category": "accessory",
		"description": "スキル再使用時間 ×0.97。",
		"skill_cd_mult": 0.97,
	},
	"eq_set_valgard_weapon": {
		"display_name": "アンティーク・武器",
		"category": "weapon",
		"description": "与ダメ ×1.06。",
		"outgoing_mult": 1.06,
	},
	"eq_set_valgard_armor": {
		"display_name": "アンティーク・鎧",
		"category": "armor",
		"description": "被ダメ ×0.95。",
		"incoming_mult": 0.95,
	},
	"eq_set_valgard_acc": {
		"display_name": "アンティーク・護符",
		"category": "accessory",
		"description": "与ダメ ×1.04。",
		"outgoing_mult": 1.04,
	},
	"eq_set_namerefuse_weapon": {
		"display_name": "名拒みの冠・武器",
		"category": "weapon",
		"description": "デバフ付与率 ×1.10。",
		"status_chance_mult": 1.10,
	},
	"eq_set_namerefuse_armor": {
		"display_name": "名拒みの冠・鎧",
		"category": "armor",
		"description": "被ダメ ×0.97。",
		"incoming_mult": 0.97,
	},
	"eq_set_namerefuse_acc": {
		"display_name": "名拒みの冠・冠環",
		"category": "accessory",
		"description": "デバフ付与率 ×1.06。",
		"status_chance_mult": 1.06,
	},
	"eq_set_forge_weapon": {
		"display_name": "星炉の滓・武器",
		"category": "weapon",
		"description": "炎上中の敵へ与ダメ ×1.08。スキル命中時15%で炎上。",
		"outgoing_vs_status_mult": 1.08,
		"outgoing_vs_status_ids": ["ignite"],
		"trigger": "on_skill_hit",
		"condition": "always",
		"effect": "apply_status",
	...
	"eq_set_forge_acc": {
		"display_name": "星炉の滓・印章",
		"category": "accessory",
		"description": "炎上中の敵へ与ダメ ×1.05。",
