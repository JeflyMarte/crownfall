		...
		"pages": [
			{
				"title": "1. イベント枠に並ぶもの",
				"body": (
					"隊長、[color=#9A5018][b]イベント[/b][/color]タブには、"
					+ "曜日の短編・時間帯の[color=#9A5018][b]降臨[/b][/color]に加え、"
					+ "常設の[color=#9A5018][b]征討[/b][/color]も並びます。\n\n"
					+ "曜日・時間で開くものと、⑤クリア後に常設で挑めるものが同居します。"
					+ "閉まっている短編は一覧に出ません。"
				),
			},
			{
				"title": "2. 曜日短編と降臨",
				"body": (
					"曜日短編は多くが[color=#9A5018][b]一日1回[/b][/color]まで"
					+ "（朝5時・日本時間でリセット）。"
					+ "[color=#7A3E12][b]コズミックダックの裂け目[/b][/color]や"
					+ "[color=#7A3E12][b]宝冠レイヴンの巣[/b][/color]などは育成向きです。\n\n"
					+ "降臨は決まった時間帯だけ門が開き、N／H／NM があります。"
					+ "詳細は「降臨とは？」からも確認できます。"
				),
			},
			{
				"title": "3. 常設の征討",
				"body": (
					"[color=#9A5018][b]征討[/b][/color]は、メイン⑤ノーマル初回クリア後に"
					+ "イベント枠へ常設で並ぶ長編です。\n\n"
