...
const CHAT_LINES: Array[String] = [
	...
	"調査ゲージは解放の鍵じゃないです。完全調査の景品用ですよ！",
	"派遣中の仲間は編成から外れます。完了したら自動で戻ります！",
	"ギルド情報誌、三十分ごとに変わるので見落とし注意です！",
	...
	match CombatWeather.normalize(weather):
		...
		CombatWeather.FOG:
			return _pick_from([
				...
				"濃霧＝腐霧注意です！回復が効きにくくて、毒は回りやすいそうです！",
				"霧注意です！毒対策と回復枠、いつもより意識していきましょうね！",
				"霧の日は音もこもります。急な遭遇に備えて、回復を切らさないで！",
			], 103)
		CombatWeather.HEAT:
			return _pick_from([
				"炎天注意です！暑さで氷属性は少し不利かも。水分…じゃなくて回復、忘れずに！",
				"日差しが強い日です！炎属性が通しやすい一方、氷は控えめにどうぞ！",
				"炎天です！熱気がこもるので、無理な長時間探索は控えめに！",
				"暑い日みたいです。炎寄せの編成が活きやすい、って記録にあります！",
				"炎天警報です！装備の耐熱というより、隊長のペース配分を意識して！",
				"灼熱寄りの空です！氷武器は少し通りにくい日かもです！",
			], 109)
		CombatWeather.SNOW:
			return _pick_from([
				"吹雪注意です！氷属性が通しやすい反面、炎は少し不利かも！",
				"吹雪日和です！視界と足元、いつもより慎重に進んでくださいね！",
				"雪が強いです！氷寄せの編成が活きやすい日みたいです！",
				"吹雪です！炎属性は少し通りにくいです。装備の見直しもどうぞ！",
				"白く霞む日です。距離感が狂いやすいので、無理な突進は控えめに！",
				"吹雪注意報です！体温…いえ、回復枠を切らさないでくださいね！",
			], 113)
		_:
			return _pick_from([
