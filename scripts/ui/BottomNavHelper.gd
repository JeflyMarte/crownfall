...
static func _wire_nav_row(nav_row: HBoxContainer, active_tab: Tab) -> void:
	...
	_connect_if_needed(nav_row.get_node_or_null("NavCharacter") as Button, _go_character)
	...
	_connect_if_needed(nav_row.get_node_or_null("NavGacha") as Button, _go_gacha)
	_connect_if_needed(nav_row.get_node_or_null("NavCodex") as Button, _go_codex)
