...
const SKILL_TO_BASE: Dictionary = {
	...
	"guard_strike": "guard",
	"iron_guard": "guard",
	"offensive_stance": "buff",
	"riposte_stance": "guard",
	"heavy_guard": "guard",
	"menace_strike": "guard",
	"stunning_blow": "guard",
	"fear_chain": "guard",
	...
	"volley_shot": "bow",
	"trail_ward": "buff",
	"hunting_ground_mark": "mark",
	"pet_bond_rally": "buff",
	"pet_command_fang": "mark",
	"pet_bond_guard": "guard",
	"pet_ash_bark": "slash",
	"pet_ash_guard": "slash",
	"pet_ash_howl": "slash",
	"pet_ash_bulwark": "mark",
	"pet_ash_aegis": "slash",
	"pet_ink_fang": "slash",
	"pet_ink_snare": "snare",
	"pet_ink_toxin": "poison",
	"pet_ink_paralyze": "guard",
	"pet_ink_hex": "hex",
	"pet_ink_rupture": "slash",
	"pet_nibble": "slash",
	"pet_pounce": "heal",
	"pet_jack_frenzy": "buff",
	"pet_jack_crack": "slash",
	"pet_jack_ward": "guard",
	"pet_jack_bulwark": "guard",
	"focus_mark": "mark",
	"hunter_mark": "mark",
	"mark_pursuit": "mark",
	"alpha_strike": "mark",
	...
	"ouga_retsudan": "slash",
	"break_edge": "slash",
	"critical_storm": "slash",
	"titan_roar": "guard",
	"iron_aura": "guard",
	"vg_gate_counter": "guard",
	"heartbeat": "heal",
	"grand_elixir": "heal",
	"dead_eye": "mark",
	"mark_shot": "mark",
	...
	"eng_break_trap": "mark",
	"eng_scrap_burst": "bow",
	"eng_trim_spike_rain": "mark",
	"eng_bran_ember_wave": "bow",
	"eng_ortho_seam_burst": "slash",
	"eng_burn_trap": "bow",
