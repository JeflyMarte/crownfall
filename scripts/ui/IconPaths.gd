...
const ICON_MAP: Dictionary = {
	...
	# 仮: 専用アート到着まで MossBoar 流用（P3-ENEMY-ROCK-BISON-001）
	"enemy:rock_bison": "res://assets/codex/enemies/ART_ENM_MossBoar.png",
	...
	"enemy_turn:rock_bison": "res://assets/ui/combat/enemy_icons/ICO_ENM_Turn_MossBoar.png",
