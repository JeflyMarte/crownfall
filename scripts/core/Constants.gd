...
## ゴールデンスカラベ日次イベントDG id。
const GOLDEN_NEST_DUNGEON_ID: String = "golden_nest"
## 影狩り日次イベントDG id。
const SHADOW_HUNT_DUNGEON_ID: String = "shadow_hunt"
## ロックバイソン日次イベントDG id。
...
const ULTIMATE_CHARGE_FILL_SECONDS: float = 25.0
