...
## blurb は Featured 黄字煽り：性能を一言・！止め。
const POOL: Array[Dictionary] = [
	{"kind": "weapon", "id": "kaiwan_crosslit", "seat": "塞図", "blurb": "初撃がとくに強い武器！", "effect": "戦闘の最初の攻撃の威力が３０％アップ！ただし、２撃目以降の威力は８％ダウン！"},
	{"kind": "weapon", "id": "kaiwan_vendict", "seat": "売境", "blurb": "火力特化の攻守トレード武器！", "effect": "与えるダメージが１８％アップ！ただし、受けるダメージが１２％アップ！"},
	{"kind": "weapon", "id": "kaiwan_silent", "seat": "裂鍵", "blurb": "バフ剥がしとデバフ強化の武器！", "effect": "敵のバフを解除する確率が３０％アップ！さらにデバフを付与する力が１５％アップ！ただし、自分のスキルの再使用時間が１０％延びる！"},
	{"kind": "weapon", "id": "kaiwan_perfidy", "seat": "違約", "blurb": "デバフ中の敵に強い武器！", "effect": "デバフ中の敵への威力が２２％アップ！ただし、味方への回復・援護効果が２０％ダウン！"},
	{"kind": "weapon", "id": "kaiwan_nox", "seat": "灯断", "blurb": "後列からの会心寄り武器！", "effect": "後列からの威力が２０％アップ！さらに会心率が８％アップ！ただし、戦闘開始時に自分のHPが８％減少する！"},
	{"kind": "weapon", "id": "kaiwan_false", "seat": "偽星", "blurb": "強化するほど伸びる育成向き武器！", "effect": "炉研ぎ・錬成の効果が１５％アップ！ただし、受けたときのクリティカル率が１０％アップ！"},
	{"kind": "weapon", "id": "kaiwan_saltine", "seat": "奪潮", "blurb": "速度と水氷を伸ばす武器！", "effect": "行動速度が１２％アップ！さらに水・氷属性の威力が１５％アップ！ただし、罠・探索ダメージが２５％アップ！"},
	{"kind": "weapon", "id": "kaiwan_wiltes", "seat": "枯翠", "blurb": "回復を火力に変える武器！", "effect": "回復スキルの半分が追加ダメージに変わる！ただし、継続回復・ターン回復が５０％ダウン！"},
	{"kind": "weapon", "id": "kaiwan_relictos", "seat": "断継", "blurb": "撃破直後に火力が乗る武器！", "effect": "敵を倒した直後の次の攻撃の威力が３５％アップ！ただし、味方が戦闘不能のあいだ自分の威力は１５％ダウン！"},
	{"kind": "armor", "id": "kaiwan_primehide", "seat": "塞図", "blurb": "開幕の被弾に強い防具！", "effect": "戦闘中、最初の被弾までのダメージが２０％ダウン！ただし、それ以降の被ダメは８％アップ！"},
	{"kind": "armor", "id": "kaiwan_bloodmail", "seat": "売境", "blurb": "被弾後に反撃火力が上がる防具！", "effect": "ダメージを受けたあと、次の攻撃の威力が１２％アップ！ただし、最大HPが１０％ダウン！"},
	{"kind": "armor", "id": "kaiwan_voidrobe", "seat": "裂鍵", "blurb": "スキル回転を速くする防具！", "effect": "自分のスキル再使用ペナルティが半分になる！ただし、与えるダメージが８％ダウン！"},
	{"kind": "armor", "id": "kaiwan_oathbreak", "seat": "違約", "blurb": "デバフ戦に強い耐久防具！", "effect": "デバフ中の敵から受けるダメージが１２％ダウン！ただし、自分が受ける回復が１５％ダウン！"},
	{"kind": "armor", "id": "kaiwan_duskmail", "seat": "灯断", "blurb": "開幕の損耗を抑える防具！", "effect": "開幕のHP減少が半分になる！ただし、前列にいると与ダメが１０％ダウン！"},
	{"kind": "armor", "id": "kaiwan_forgepate", "seat": "偽星", "blurb": "強化効果をさらに伸ばす防具！", "effect": "炉研ぎ・錬成の効果がさらに１０％アップ！ただし、被クリティカル率がさらに８％アップ！"},
	{"kind": "armor", "id": "kaiwan_tideskin", "seat": "奪潮", "blurb": "罠ダメージを軽減する防具！", "effect": "罠・探索ダメージのペナルティが半分になる！ただし、炎属性の被ダメが１５％アップ！"},
	{"kind": "armor", "id": "kaiwan_thornmail", "seat": "枯翠", "blurb": "回復変換の火力を伸ばす防具！", "effect": "回復を与ダメへ変換する率が１５ポイントアップ！ただし、受ける回復が２０％ダウン！"},
	{"kind": "armor", "id": "kaiwan_lastcoil", "seat": "断継", "blurb": "撃破後の余韻を伸ばす防具！", "effect": "撃破後のバフ時間が延びる！ただし、味方戦闘不能時の与ダメペナが２０％に悪化する！"},
	{"kind": "accessory", "id": "kaiwan_initio", "seat": "塞図", "blurb": "初撃の会心を盛る装飾！", "effect": "初撃の会心率が２５％アップ！ただし、２撃目以降の会心は１０％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_venomband", "seat": "売境", "blurb": "与ダメ特化の装飾！", "effect": "与えるダメージが１０％アップ！ただし、回復効果が１５％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_unlock", "seat": "裂鍵", "blurb": "バフ解除に乗せる装飾！", "effect": "バフ解除に成功すると追加で小ダメージ！ただし、味方へのバフ効果時間が１５％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_curseband", "seat": "違約", "blurb": "追加デバフを狙う装飾！", "effect": "攻撃時、低確率で追加デバフを付与！ただし、援護・オーラ系効果が２５％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_nocturne", "seat": "灯断", "blurb": "開幕コストを初撃に乗せる装飾！", "effect": "開幕に失ったHPの割合が初撃の威力に上乗せ！ただし、戦闘中のHP回復が３０％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_sparkle", "seat": "偽星", "blurb": "強化ほど与ダメが伸びる装飾！", "effect": "強化が進むほど与ダメが上がる！ただし、未強化だと与ダメが２０％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_reefhook", "seat": "奪潮", "blurb": "水氷と速度を伸ばす装飾！", "effect": "水・氷属性の威力が１０％アップ！さらに行動速度が５％アップ！ただし、聖属性耐性が１０％ダウン！"},
	{"kind": "accessory", "id": "kaiwan_wither", "seat": "枯翠", "blurb": "回復を代償に火力へ変える装飾！", "effect": "回復するたびに自分にも軽いダメージが入り、そのぶん与ダメが上がる！ただし、蘇生や強回復はほぼ効かない！"},
	{"kind": "accessory", "id": "kaiwan_nextedge", "seat": "断継", "blurb": "撃破連鎖を伸ばす装飾！", "effect": "撃破連鎖の２回目にも半分の補正が乗る！ただし、戦闘開始時のSPが１０％ダウン！"},
]
